...
def test_failure_tracker
  ...
  # Cleanup
  begin
    File.delete("#{TEST_PROJECT}/.claude/failure_state.json")
  rescue StandardError
    nil
  end
  begin
    File.delete("#{TEST_PROJECT}/.claude/circuit_breaker.json")
  rescue StandardError
    nil
  end
end
...
def test_session_start
  ...
  return unless File.exist?(breaker_file)
